...
/**
 * Control class for the Change Password function <br>
 * <br>
    ...
    try {
      ...
      if (Validate.validateSession(ses)) {
        ...
        if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
          ...
          validData =
              newPassword != null && !newPassword.isEmpty() && newPassword.equals(passwordConfirm);
          passwordChange = !currentPassword.equals(newPassword);
          validPassword = validData && Validate.isValidPassword(newPassword);
