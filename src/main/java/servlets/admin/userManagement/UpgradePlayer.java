...
/**
 * Control class of the Upgrade player to admin functionality <br>
 * <br>
...
public class UpgradePlayer extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(UpgradePlayer.class);

  /**
   * Initiated by upgradePlayers.jsp. This method upgrades multiple players to administrators at a
   * time. Changing the actual role of the player is handed by Setter.updateUserRole.
   *
   * @param classId
   * @param players
   * @param csrfToken
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      if (Validate.validateTokens(ses, tokenCookie, tokenParmeter)) {
        ...
        try {
          ...
          if (notNull && validPlayer) {
            ...
            if (userName != null) {
              reponseMessage +=
                  "<a>"
                      ...
                      + "</a> upgraded successfully to administrator.<br>";
            } else {
              reponseMessage +=
                  "<font color='red'>User could not be updated. Please try again.</font><br/>";
            }
            out.print(
                "<h3 class=\"title\">Player Upgrade Result</h3>" + "<p>" + reponseMessage + "<p>");
          } else {
            ...
            out.print(
                "<h3 class=\"title\">Player Upgrade Failure</h3>"
                    + "<p><font color=\"red\">"
      ...
      out.print(
          "<h3 class=\"title\">Player Upgrade Failure</h3><p><font color=\"red\">An error Occurred!"
