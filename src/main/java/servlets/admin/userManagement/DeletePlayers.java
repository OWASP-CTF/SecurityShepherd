...
/**
 * The delete players server side functionality is hanled by this control class <br>
 * <br>
...
public class DeletePlayers extends HttpServlet {
  ...
  /**
   * Initiated by deletePlayers.jsp. Deletion of player from Core Database is handed by
   * Setter.deleteUser
   *
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
        ...
        try {
          ...
          if (notNull && validPlayer) {
            ...
            if (Setter.userDelete(ApplicationRoot, player)) {
              ...
              reponseMessage +=
                  "<font color='red'>User could not be deleted. Please try again.</font><br/>";
            }

            out.print(
                "<h3 class=\"title\">Player Deletion Result</h3>" + "<p>" + reponseMessage + "<p>");
          } else {
            ...
            out.print(
                "<h3 class=\"title\">Player Deletion Failure</h3>"
                    + "<p><font color=\"red\">"
      ...
      out.print(
          "<h3 class=\"title\">Player Deletion Failure</h3><p><font color=\"red\">An error"
