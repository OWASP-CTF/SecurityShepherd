...
/**
 * Control class of the "Suspend User" functionality <br>
 * <br>
            ...
            if (Setter.suspendUser(ApplicationRoot, player, amountOfMinutes)) {
              ...
              reponseMessage +=
                  "<a>"
                      ...
                      + "</a> has been suspended for <b>"
                      + amountOfMinutes
                      + "</b> minutes.";
            } else {
              reponseMessage +=
                  "<font color='red'>User could not be suspended. Please try again.</font>";
            }
            out.print(
                "<h3 class=\"title\">User Suspended</h3>"
                    + "<p>"
                    + reponseMessage
