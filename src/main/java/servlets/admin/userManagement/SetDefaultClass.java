...
/**
 * This is the control class for the Set Default Class functionality <br>
 * <br>
...
public class SetDefaultClass extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(SetDefaultClass.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      out.print(
          "<h3 class=\"title\">Failure</h3><p><font color=\"red\">An error Occurred! Please try non"
