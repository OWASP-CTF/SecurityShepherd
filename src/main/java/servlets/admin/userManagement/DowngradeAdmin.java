...
/**
 * Control class of the Downgrade player to admin functionality <br>
 * <br>
...
public class DowngradeAdmin extends HttpServlet {
  ...
  /**
   * Initiated by downgradeAdmins.jsp. This method downgrades a single admin to player at a time.
   * Changing the actual role of the admin is handed by Setter.updateUserRole.
   *
   * @param classId
   * @param players
   * @param csrfToken
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      if (Validate.validateTokens(ses, tokenCookie, tokenParmeter)) {
        ...
        try {
          ...
          if (notNull && validPlayer) {
            ...
            out.print(
                "<h3 class=\"title\">Admin Downgrade Result</h3>" + "<p>" + reponseMessage + "<p>");
          } else {
            ...
            out.print(
                "<h3 class=\"title\">Admin Downgrade Failure</h3>"
                    + "<p><font color=\"red\">"
      ...
      out.print(
          "<h3 class=\"title\">Admin Downgrade Failure</h3><p><font color=\"red\">An error"
