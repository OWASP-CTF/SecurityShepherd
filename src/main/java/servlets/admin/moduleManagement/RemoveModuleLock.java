...
/**
 * Class to remove an optional blocking module that had been enabled. <br>
 * <br>
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      if (Validate.validateTokens(ses, tokenCookie, tokenParmeter)) {
        try {
          ...
          ModuleBlock.reset();
          out.write(
              "<h2 class='title'>Blocker Disabled</h2><p>There is no longer any module blocker"
                  + " enabled on the application. All levels can be completed.</p>");
        } catch (Exception e) {
