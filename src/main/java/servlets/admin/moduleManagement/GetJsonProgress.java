...
/**
 * This control class is responsible for the server operation in the Get Progress use case where the
 * result of which is a JSON object of JSON arrays. This is used to create a scoreboard environment
 * that updates in real time. This Servlet should be poled regularly to achieve this. <br>
 * <br>
