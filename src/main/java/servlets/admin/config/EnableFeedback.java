...
/**
 * This class is responsible for requests to configure the applications Feedback Status. It is used
 * specifically to enable feedback <br>
 * <br>
...
public class EnableFeedback extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(EnableFeedback.class);
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      if (Validate.validateTokens(ses, tokenCookie, tokenParmeter)) {
        try {
          ...
          out.print(
              "<h3 class=\"title\">Feedback Enabled</h3><br>"
                  + "<p>"
          ...
          out.print(
              "<h3 class=\"title\">Enable Feedback Failure</h3><br>"
                  + "<p>"
      ...
      out.print(
          "<h3 class=\"title\">Enable Feedback Failure</h3><br><p><font color=\"red\">An error"
              + " Occurred! Please log in or try non administrator functions!</font><p>");
    }
