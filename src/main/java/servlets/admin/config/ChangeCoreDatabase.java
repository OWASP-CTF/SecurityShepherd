...
/**
 * This class is responsible for requests to configure the applications core database sign on
 * information. <br>
 * <br>
...
public class ChangeCoreDatabase extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(ChangeCoreDatabase.class);

  /**
   * If this method is called by a valid administrator the site.properties file that contains the
   * database information required to make a connection is updated
   *
   * @param csrfToken
   */
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      out.print(
          "<h3 class=\"title\">Core Database Info Update Failure</h3><br><p><font color=\"red\">An"
