 ...
 * specifically to disable feedback <br>
 * <br>
...
public class DisableFeedback extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    log.debug("*** servlets.Admin.config.DisableFeedback ***");
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      if (Validate.validateTokens(ses, tokenCookie, tokenParmeter)) {
        try {
          ...
          out.print(
              "<h3 class=\"title\">Feedback Disabled</h3><br>"
                  + "<p>"
          ...
          out.print(
              "<h3 class=\"title\">Disable Feedback Failure</h3><br>"
                  + "<p>"
      ...
      out.print(
          "<h3 class=\"title\">Disable Feedback Failure</h3><br><p><font color=\"red\">An error"
