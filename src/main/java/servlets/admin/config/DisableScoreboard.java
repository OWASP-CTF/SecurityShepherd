...
/**
 * This is the control class for disabling the the user accessible scoreboard <br>
 * <br>
...
public class DisableScoreboard extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(DisableScoreboard.class);
    ...
    if (Validate.validateAdminSession(ses, tokenCookie, tokenParmeter)) {
      ...
      if (Validate.validateTokens(ses, tokenCookie, tokenParmeter)) {
        try {
          ...
          htmlOutput =
              "<h3 class='title'>Scoreboard Settings Updated</h3>" + "<p>" + htmlOutput + "</p>";
