...
public class SolutionSubmit extends HttpServlet {
  ...
  /**
   * Initiated by a dynamic form in index.jsp this method checks the existence of the submitted
   * module identifier before ensuring that the submission is correct If the submission is found to
   * be valid then the user is returned with a feedback form.
   *
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
        ...
        log.debug("solutionKey = " + solutionKey);
  ...
  /**
   * The method responsible for generating the feedback form based on the valid input submitted by
   * the user when initiating the doPost() method. This data will have to be re-assessed when it is
   * used to submit feedback as the user has an opportunity to modify the parameters they are
   * sending.
   *
  ...
  private static String feedbackForm =
      "<div id=\"badData\"></div>\n"
          ...
          + "	<input type=\"radio\" name=\"difficulty\" id=\"difficulty\" value=\"0\""
          + " style=\"display: none;\"/>\n"
          ...
          + "		</tr>\n"
          + "		<tr>\n"
          + "			<td>Very Easy: <input type=\"radio\" name=\"difficulty\" id=\"difficulty\""
          + " value=\"1\"/></td>\n"
          + "			<td>Easy: <input type=\"radio\" name=\"difficulty\" id=\"difficulty\""
          + " value=\"2\"/></td>\n"
          + "			<td>Fair: <input type=\"radio\" name=\"difficulty\" id=\"difficulty\""
          + " value=\"3\"/></td>\n"
          + "			<td>Hard: <input type=\"radio\" name=\"difficulty\" id=\"difficulty\""
          + " value=\"4\"/></td>\n"
          + "			<td>Very Hard: <input type=\"radio\" name=\"difficulty\" id=\"difficulty\""
          + " value=\"5\"/></td>\n"
          + "		</tr>\n"
          + "		<tr>\n"
          + "			<td colspan=\"5\">\n"
          + "				<p>What was your knowlege of the module's topic <a>before</a> you started this"
          + " module</p>\n"
          + "			</td>\n"
          + "		</tr>\n"
          + "		<tr>\n"
          + "			<td>None: <input type=\"radio\" name=\"before\" id=\"before\" value=\"1\"/></td>\n"
          + "			<td>Little: <input type=\"radio\" name=\"before\" id=\"before\""
          + " value=\"2\"/></td>\n"
          + "			<td>Average: <input type=\"radio\" name=\"before\" id=\"before\""
          + " value=\"3\"/></td>\n"
          + "			<td>Advanced: <input type=\"radio\" name=\"before\" id=\"before\""
          + " value=\"4\"/></td>\n"
          + "			<td>Expert: <input type=\"radio\" name=\"before\" id=\"before\""
          + " value=\"5\"/></td>\n"
          + "		</tr>\n"
          + "		<tr>\n"
          + "			<td colspan=\"5\">\n"
          + "				<p>What was your knowlege of the module's topic <a>after</a> you completed this"
          + " module</p>\n"
          + "			</td>\n"
          + "		</tr>\n"
          + "		<tr>\n"
          ...
          + "			<td>Advanced: <input type=\"radio\" name=\"after\" id=\"after\""
          + " value=\"4\"/></td>\n"
  ...
  private static String feedbackForm3 =
      "\"\n"
          ...
          + "			else\n"
          + "			{\n"
          + "				$(\"#badData\").html(\"<p> An Error Occurred: \" + ajaxCall.status + \" \" +"
