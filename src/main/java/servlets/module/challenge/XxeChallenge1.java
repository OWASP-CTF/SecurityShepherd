 ...
 * @author ismisepaul
 */
public class XxeChallenge1 extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    ResourceBundle bundle =
        ResourceBundle.getBundle("i18n.servlets.challenges.injection.xxe1", locale);
    ...
    try {
      filename =
          FileInputProperties.readPropFileClassLoader(
              "fileSystemKeys.properties", "xxe.challenge.1.file");
      solution =
          FileInputProperties.readPropFileClassLoader(
              "fileSystemKeys.properties", "xxe.challenge.1.solution");
