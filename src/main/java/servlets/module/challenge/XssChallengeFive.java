    ...
    try {
      ...
      if (Validate.validateSession(ses)) {
        ...
        if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
          ...
          // The whitelist filter still leaves the href breakable, so what is actually
          // rendered must be re-encoded for the attribute context, and the key graded on
          // that value rather than the still-dangerous string the filter produced.
