...
public class DirectObjectBankCurrentBalance extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(DirectObjectBankCurrentBalance.class);
  ...
  /**
   * This Servlet is used by users to register a new bank account in the Insecure Direct Object Bank
   * Challenge.
   */
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        // The balance served is always for the account this session is authenticated against. The
        // account number in the request is a direct object reference and is not trusted.
