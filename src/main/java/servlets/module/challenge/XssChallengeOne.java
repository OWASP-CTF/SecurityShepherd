...
public class XssChallengeOne extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(XssChallengeOne.class);
    ...
    try {
      ...
      if (Validate.validateSession(ses)) {
        ...
        if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
          ...
          // legacy keyword blacklist is kept only for backwards compatibility.
          searchTerm = Encode.forHtml(XssFilter.levelOne(searchTerm));
