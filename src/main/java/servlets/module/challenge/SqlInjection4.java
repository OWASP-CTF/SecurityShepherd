  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        // Bind both credentials as parameters instead of concatenating them into the statement, so
        // neither field can close the quoted literal and alter the WHERE clause (the classic
