    ...
    try {
      ...
      if (Validate.validateSession(ses)) {
        ...
        if (ses.getAttribute("csrfChallengeFiveNonce") == null
          ...
          // random.nextInt(3) only ever produces one of 3 possible values, letting an attacker
          // brute-force a valid nonce in at most 3 tries without ever touching the victim's
          // session. Hash.randomString() matches the real-random pattern used elsewhere.
