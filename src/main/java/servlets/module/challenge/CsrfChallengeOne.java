...
/**
 * Cross Site Request Forgery Challenge One - Does not return reslut key <br>
 * <br>
...
public class CsrfChallengeOne extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(CsrfChallengeOne.class);
    ...
    try {
      ...
      if (Validate.validateSession(ses)) {
        ...
        if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
          ...
          String htmlOutput =
              Getter.getCsrfForumWithImg(ApplicationRoot, classId, moduleId, csrfGenerics);
