...
/**
 * Cross Site Request Forgery Challenge Four - Does not return result Key <br>
 * <br>
...
public class CsrfChallengeFour extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(CsrfChallengeFour.class);
