...
/**
 * Cross Site Request Forgery Challenge Five - Does not return result Key <br>
 * <br>
...
public class CsrfChallengeFive extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(CsrfChallengeFive.class);
    ...
    try {
      ...
      if (Validate.validateSession(ses)) {
        ...
        if (Validate.validateTokens(tokenCookie, tokenParmeter)) {
          ...
          String moduleId =
              Getter.getModuleIdFromHash(ApplicationRoot, CsrfChallengeFive.levelHash);
