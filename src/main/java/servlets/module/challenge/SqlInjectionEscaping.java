  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        // The id is bound below, so it needs no hand-rolled escaping. Escaping the quote but
        // not the backslash was what let a trailing backslash consume the closing quote.
