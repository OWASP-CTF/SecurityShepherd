  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        // Bind the user-supplied value as a query parameter instead of manually
        // escaping quote characters and concatenating it into the SQL text. Manual
        // character-by-character escaping (e.g. replacing ' with \') can be defeated
        // by an attacker-supplied backslash placed immediately before the quote,
        // which neutralises the inserted escape backslash and re-opens the string
        // literal. A PreparedStatement placeholder is never interpreted as SQL
        // syntax regardless of its content, closing that bypass entirely.
