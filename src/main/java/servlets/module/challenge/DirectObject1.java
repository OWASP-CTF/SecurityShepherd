...
/**
 * Insecure Direct Object Challenge Challenge One Does not use user specific key because key is
...
public class DirectObject1 extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    ResourceBundle bundle =
        ResourceBundle.getBundle("i18n.servlets.challenges.directObject.directObjectRef1", locale);
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        String userStamp = (String) ses.getAttribute("userStamp");
        if (userStamp != null && userStamp.equals(userId)) {
          Connection conn =
          ...
          log.debug("Unauthorized cross-user lookup attempt - denying access");
