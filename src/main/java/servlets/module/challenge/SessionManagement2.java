    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        if (resultSet.next()) {
          ...
          // Do not reveal whether the username exists or its email address - a generic message
          // for any failed login prevents username enumeration and email disclosure.
