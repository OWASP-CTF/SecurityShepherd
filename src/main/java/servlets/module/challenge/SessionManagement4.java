...
public class SessionManagement4 extends HttpServlet {
  ...
  /** Handles access to the sub-application using authorization state held in the server session. */
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (Validate.validateSession(ses)) {
        ...
        String subSessionUserId = (String) ses.getAttribute("sessionManagement4UserId");
        if (subSessionUserId == null) {
          subSessionUserId = "0000000000000001";
          ses.setAttribute("sessionManagement4UserId", subSessionUserId);
        }
        String htmlOutput = null;
        if (subSessionUserId.equals("0000000000000001")) // Guest Session
        {
          log.debug("Guest Session Detected");
        } else if (subSessionUserId.equals("0000000000000009")) // Admin Session
        {
