...
public class SessionManagement3ChangePassword extends HttpServlet {
   ...
   * user name stored in the server-side challenge session
   *
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (Validate.validateSession(ses)) {
      ...
      try {
        ...
        Object subNameObj = ses.getAttribute("sessionManagement3User");
        String subName = subNameObj instanceof String ? (String) subNameObj : new String();
