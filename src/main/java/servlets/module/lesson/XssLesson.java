 ...
 * @author Mark Denihan
 */
public class XssLesson extends HttpServlet {
  ...
  /**
   * Cross Site Request Forgery safe Reflected XSS vulnerability. cannot be remotely deployed, and
   * therefore only is executable against the person initiating the function.
   *
