...
public class CsrfLesson extends HttpServlet {
  ...
  /**
   * User submission is parsed for a valid HTML IMG tag. The SRC attribute of this tag is then used
   * to construct a URL object. This URL object is then checked to ensure a valid attack
   *
