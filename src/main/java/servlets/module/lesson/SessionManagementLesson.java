...
public class SessionManagementLesson extends HttpServlet {
  ...
  private static final Logger log = LogManager.getLogger(SessionManagementLesson.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    ResourceBundle bundle =
        ResourceBundle.getBundle("i18n.servlets.lessons.sessionManagement", locale);
