...
public class RefreshMenu extends HttpServlet {
  ...
  /**
   * This servlet returns a fresh version of the module menu bar. This is used when completing
   * levels, changing the floor plan or when opening/closing challenges.
   *
   * @param csrfToken
   */
            ...
            try {
              out.write(
                  "<li><a id=\"lessonList\" href=\"javascript:;\"><div class=\"menuButton\">"
                      ...
                      + Getter.getChallenges(ApplicationRoot, userId, locale)
                      + "</ul></li>"
