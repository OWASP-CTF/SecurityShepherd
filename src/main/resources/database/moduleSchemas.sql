...
START TRANSACTION;
USE `BrokenAuthAndSessMangChalSeven`;
INSERT INTO `BrokenAuthAndSessMangChalSeven`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (1224, 'manager', 		'!148972hsfalkjlkfi381', 'h2ecwq8nvtx6mydk5b@shepherd.com',		'What is your favourite flower?', 'Jade Vine');
INSERT INTO `BrokenAuthAndSessMangChalSeven`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (1225, 'sean',	 		'!148972hsfalkjlkfi381', 's7lgu1pafzo3rjnc9x@shepherd.com',		'What is your favourite flower?', 'Corpse Flower');
INSERT INTO `BrokenAuthAndSessMangChalSeven`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (3214, 'administrator', 	'!148972hsfalkjlkfi381', 'd6kxvm0trwya4qphel@shepherd.com','What is your favourite flower?', 'Gibraltar Campion');
INSERT INTO `BrokenAuthAndSessMangChalSeven`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (3212, 'root', 			'!148972hsfalkjlkfi381', 'n8zfj5bcqi2osdrutg@shepherd.com',	'What is your favourite flower?', 'Franklin Tree');
INSERT INTO `BrokenAuthAndSessMangChalSeven`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6344, 'superuser', 		'!148972hsfalkjlkfi381', 'y3wpad7nkxvebm1cjr@security.com',	'What is your favourite flower?', 'Jade Vine');
INSERT INTO `BrokenAuthAndSessMangChalSeven`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (4524, 'privileged', 		'1489!72hsfalkjlkfi381', 'f0uqhs9zmldbe4vxtn@security.com',	'What is your favourite flower?', 'Middlemist Red');
