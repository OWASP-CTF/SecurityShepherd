...
START TRANSACTION;
USE `BrokenAuthAndSessMangChalFive`;
INSERT INTO `BrokenAuthAndSessMangChalFive`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `userRole`) VALUES (12, 'admin', 'f3a6f4cb8c62ba06d48880f727d5b98d7a0503cf', 'zoidberg22@shepherd.com', 'admin');
INSERT INTO `BrokenAuthAndSessMangChalFive`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `userRole`) VALUES (321, 'administrator', 'ad810a2301e8225c89e12570d5ea669f3833240e', 'buzzthebald@shepherd.com', 'admin');
INSERT INTO `BrokenAuthAndSessMangChalFive`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `userRole`) VALUES (3212, 'root', '7d8724a0f78de8d16f6c738615ec746d53d12389', 'elitehacker@shepherd.com', 'admin');
INSERT INTO `BrokenAuthAndSessMangChalFive`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `userRole`) VALUES (634, 'superuser', '73091c847f8bf7f083fc4c3cb4972d541f08df01', 'superman@security.com', 'admin');
INSERT INTO `BrokenAuthAndSessMangChalFive`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `userRole`) VALUES (4524, 'privileged', '4264cef5ed0e51d676d1fcaf7d4a1a6a866f25b1', 'spoiltbrat@security.com', 'admin');
