...
START TRANSACTION;
USE `sqlInjectSeven`;
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (40, 'User 1', '8671d07bb166fda6b52332768eb10d7765c403283a38e4f5e636becf84b513fc', 'UserJohn1@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (41, 'User 2', 'e7a45127a6c5f2a27623c8ae5299f3c94f3ce74e04217d2ce81ba94c818a5003', 'UserJim2@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (42, 'User 3', '4d7b6ea2318bcd8b213c55de8ed3b79908a5716291fc11d1ebe9e00a16680607', 'UserJone3@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (43, 'User 4', '43aca2e66f0e71b73b9b8bfca59f22df9ff5ce0081444e1d1bea9ba004c95d27', 'UserBell4@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (44, 'User 5', 'b27d0bc137dfcb5900cd225a7664c9d88a2e9614e0d1dc16f81f76ca61e3a9bd', 'UserConan5@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (45, 'User 6', '711fcd50a95d802c1c430acdabb7f99817f779fd82a91991b5a55224d3ab0cec', 'UserSmioth6@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (46, 'User 7', '4f779815ed454ea106de740ae0d18e0f370623976430dc0ee41cf57f952e49a5', 'UserHat7@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (47, 'User 8', '24d348aa9055c9d7878c91f4a7517d3a27576d16ff6bc4e5e70c6a26678c02b9', 'UserPage8@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (48, 'User 9', '83d951df1cffab20adadd54553953c349aa39fc203565c448218ef0be13ae497', 'UserCube9@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (49, 'User 11', 'e59a28bcfdf3b8fda82ffeb6150a334be2618662b00f89181c0958bcb6942c9e', 'MrsJohn1@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (50, 'User 12', '307670956bf715ba1fd1ea8d703f102102c4716ae854fde9733cf2e9e5c82efd', 'MrsJim2@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (51, 'User 13', '02763bdb8435da21f2e71a66bfffbbb05ec272e2192e11ca53cfad2245b81318', 'MrsJone3@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (52, 'User 14', '4ea1194772a41e0cad5509c917ebaa83df4abf8296c35efc6c947bcc230a2a49', 'MrsBell4@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (53, 'User 15', '1db049d9eae28a44cecfb2771a0bc6138025b9e763b7404c4c9828f0d9f315f7', 'MrsConan5@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (54, 'User 16', 'b1dcdee910bb0f327753e4769629062ec724f13557b1646e4203f2926b1e19b0', 'MrsSmioth6@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (55, 'User 17', 'eb33e5799fc741d931d4afc03ca9bc3812d425f043ea32e1b3141a8200c2bf05', 'MrsHat7@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (56, 'User 18', '2d6941ac8be3914a1198218671638ca1371c01f03be279c8fb0d2c5e63c26593', 'MrsPage8@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (57, 'User 19', 'e578eb0b6d76f8e1e5fa8560e1c29d6e1d1d7fe31bae81e0f7878981d5ad66ba', 'MrsCube9@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (58, 'User 20', '2b3726381820517cc1e32d6a75f94a37b599d6d468ada68158d408218dc3a5c5', 'Mr20@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (59, 'User 21', 'e338052d71e6e128c7af7c8308b49eab471ba3785634a4c2a43e355fc6af67ec', 'Mr2John1@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (60, 'User 22', '78a9b2a040eca66e51a02c47b2c66622c9a1afb535cc21367a50ff3b40df08c6', 'Mr2Jim2@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (61, 'User 23', '3069b2dcdcda2b5aecb669f15e1fc0645145c86b399c976c4eb45da49bdfeb43', 'Mr2Jone3@User.com', 'default');
INSERT INTO `sqlInjectSeven`.`users` (`userId`, `userName`, `userPassword`, `userEmail`, `userRole`) VALUES (62, 'User 10', '803c2c08258f1b3ed85464a145ac73f9b7b949659c6fccd169c71417c844d9c1', 'Mrs0@User.com', 'default');
