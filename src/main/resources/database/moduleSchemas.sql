...
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (3214, 'administrator', 	'!148972hsfalkjlkfi381', 'k9pt2vqx4mzhw7dbnr@shepherd.com','What is the last name of the teacher who gave you your first failing grade?', 'Aran Keegan');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (3212, 'root', 			'!148972hsfalkjlkfi381', 'j4hs8cyd1lofmt5wax@shepherd.com','What is the name of the place your wedding reception was held?', 'Deerburn Hotel');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6344, 'superuser', 		'!148972hsfalkjlkfi381', 'q7bnv3ekz9puyi2rdg@security.com',	'Who was the first person to beat you up when you were 8 years old?', 'Lileas Lockwood');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (4524, 'privileged', 		'1489!72hsfalkjlkfi381', 'w5xmc0tafj8ldkpe1s@security.com',	'What was the name of the person who stole your TV the second time?', 'Olwen Sordi');
