...
START TRANSACTION;
USE `BrokenAuthAndSessMangChalSix`;
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (1224, 'manager', 		'5be9a6f85622d829a4ef6481279c577daddc504d', 'zoidberg23@shepherd.com',	'What is the first name of the person you first kissed?', '2WTQWoSnNRpPWDwbG2ikiY');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (1225, 'sean',	 		'1a50a401ecf0b5f34d74b1d36b458551ee2dc41c', 'zoidberg24@shepherd.com',	'What is the first name of the person you first kissed?', 'Odj9IvXAVz60CSYBekGmhC');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (3214, 'administrator', 	'e6f512e06db4d0b591f7220423007a8cebf83fd1', 'buzzthebald@shepherd.com','What is the last name of the teacher who gave you your first failing grade?', 'hxiGO9nT8IEJgeYeCZBUd7');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (3212, 'root', 			'4ed394012e6dd17d7b3a9915743cb6cf5cfa5d4d', 'elitehacker@shepherd.com','What is the name of the place your wedding reception was held?', 'WIgDICfwQBzwp4YWhACDXz');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6344, 'superuser', 		'fab9b0f3311188124fd062fe1f029e8384104219', 'superman@security.com',	'Who was the first person to beat you up when you were 8 years old?', 'd3c6U3eQlCbk2lhry22A4J');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (4524, 'privileged', 		'5c6d4cd5785c43c1413b67dd793ee03d03bcf820', 'spoiltbrat@security.com',	'What was the name of the person who stole your TV the second time?', 'u4F8uoUDd0b84ayKP0EHGL');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6343, 'mark', 			'd980ff005d571de5cc6e9a78c0c3bea4d6401edd', 'superman2@security.com',	'Who is your favourite Barista?', 'leBvHpPDscbZLuSG8GlPQ4');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6342, 'markdenihan', 	'2cd7958098b2359cff63b17af1f5568bdf5a15e1', 'superman3@security.com',	'Who is your most favourite person you have not met?', '006scXMr28hnBTBM6IUahC');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6341, 'seanduggan', 		'df4779f7aa332c36064988dcbb25bbd8e3d42b59', 'superman4@security.com',	'Who is your most favourite person you have not met?', 'xS0PUr9X0zA0cA8SAYV2yR');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6551, 'rootuser', 		'c52fbeec3e4ae39fc7dd8c395b52db9b16650fea', 'superman6@security.com',	'Who is your most favourite person you have not met?', 'E9MJBtInbZXBUD8u3JskRa');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6552, 'adminuser', 		'a972040ebe401662b6a0d63698a9ab8554dbfa49', 'superman7@security.com',	'Who is your most favourite person you have not met?', 'LvD3DxkT8DSMWp7DCCeqF7');
INSERT INTO `BrokenAuthAndSessMangChalSix`.`users` (`userId`, `userName`, `userPassword`, `userAddress`, `secretQuestion`, `secretAnswer`) VALUES (6559, 'shepherd', 		'21d38e072c95764061816d3d0b803a4a5138f038', 'superman8@security.com',	'Who is your most favourite person you have not met?', 'pxKQj4PuDi4DO8GWKcsysb');
