...
<body>
	...
	<%
		/*
		The clean code copy of couponCheck.js used to live here. It carried a second copy of
		the hard coded 3DES key and of the cipher text of every coupon code, so it has been
		removed along with the client side coupon check itself.
		*/
