...
<body>
	...
	<%
	/*
	The de-obfuscated source of couponCheck.js used to be kept here for reference. It carried the
	DES key, the IV and the encrypted list of every coupon code, which is the whole secret this
	page is built around. Since the script itself no longer ships that material, this copy of it
	has been removed as well rather than left sitting under the web root.
	*/
	%>
</body>
</html>
