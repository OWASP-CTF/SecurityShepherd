...
<body>
	...
	<%-- Coupon codes are validated by the server. The previous client-side check shipped a DES
	     key to the browser, so the valid coupons could be recovered from it (ASVS 11.2). --%>
	<% if(Analytics.googleAnalyticsOn) { %><%= Analytics.googleAnalyticsScript %>
	<% } %>
	<%
		/* The client-side coupon check and its embedded DES key have been removed. */
